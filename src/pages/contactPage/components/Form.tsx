    ...
    <form onSubmit={handleSubmit(onSubmit)} className={styles.container}>
      <div className={styles.inputContainer}>
        ...
        <div className={styles.withErrorsContainer}>
          <input type="text" id='name' {...register("name")} placeholder='Abc' className={styles.input} />
      ...
      <div className={styles.inputContainer}>
        ...
        <div className={styles.withErrorsContainer}>
          <input type="email" id='email' {...register("email")} placeholder='Abc@def.com' className={styles.input} />
      ...
      <div className={styles.inputContainer}>
        ...
        <div className={styles.withErrorsContainer}>
          <textarea id='message' {...register("message")} maxLength={300} placeholder='Hi! i’d like to ask about' className={`${styles.input} h-28 resize-none`} />
